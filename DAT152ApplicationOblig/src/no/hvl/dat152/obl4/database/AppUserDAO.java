...
public class AppUserDAO {
	...
	public AppUser getAuthenticatedUser(String username, String password) {
		...
		String safeSql = "SELECT * FROM SecOblig.AppUser " + "WHERE username = ? " + "AND passhash = ?";
...
//			r = s.executeQuery(sql);
	...
	public boolean saveUser(AppUser user) {
		...
		String sql = "INSERT INTO SecOblig.AppUser VALUES (" + "'" + user.getUsername() + "', " + "'"
				...
				+ "'" + user.getMobilephone() + "', " + "'" + user.getRole() + "')";
	...
	public String generatePassHash(String password) {
		...
		// return DigestUtils.md5Hex(password); -Opprinnelig kode
	}
