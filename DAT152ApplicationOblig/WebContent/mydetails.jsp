...
<body>
	...
	<table>
		...
		<tr><td><input type="radio" name="sortkey" value="searchkey">Search Word<br></td></tr><tr>	
		<td><p><input type="submit" value="Sort"/></p></td>
		</tr>
	</table>
	<input type="hidden" name="csrftoken" value="<%= session.getAttribute("crsftoken") %>"/>
	</form>
	<br>
